...
class Meta_Revisioning
{
	...
	public function __construct()
	{
		...
		add_filter('_wp_post_revision_fields', array($this, 'register_revision_fields'));
	}
	...
	public function wp_post_revision_meta_keys()
	{
		 ...
		 */
		return apply_filters('wp_post_revision_meta_keys', array('_display_data', '_schema_template')); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals
	}
	...
	public function register_revision_fields($fields)
	{
		$fields['_display_data'] = 'Display Conditions';
		$fields['_schema_template'] = 'Template';
		return $fields;
	}
}

$wp_post_meta_revisioning = new Meta_Revisioning();
